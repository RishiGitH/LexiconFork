      ...
      <div className="flex-none flex items-center justify-between px-4 py-3 bg-black/90 border-b border-gray-800/50">
        <div className="flex items-center gap-2">
          <div className="relative">
            <img
              src="https://res.cloudinary.com/dd37i7jgq/image/upload/v1736028003/ux7q82py3zaxjhggusdv.webp"
              alt="Lexicon AI"
      ...
      >
        ...
        <div className="flex items-start gap-3 animate-fade-in">
          ...
          <div className="bg-gradient-to-br from-[#1e1e1e] to-[#1a1a1a] text-white/90 rounded-2xl rounded-tl-none px-5 py-4 max-w-[85%] shadow-xl">
            <p className="text-white font-medium">👋 Welcome to OrbisAI</p>
            <p className="mt-2 text-white/70 text-sm leading-relaxed">
              I'm your specialized assistant for the Orbis AI Platform. Ask me
              anything about data labeling, decentralization, or exploring the
              ecosystem! You can also ask me to filter out relevant task for you.
            </p>
          </div>
        </div>
